...
extern std::map<k_v_pair, Policy *> g_fault_model; // Map of forbidden <state, operator> pairs indexed by the number of faults and the set of forbidden ops
extern Policy *g_original_policy; // First policy generated by the planner

extern std::map<k_v_pair, StateRegistry *> g_resilient_state_registries; // Map of resilient state registries indexed by the number of faults and the set of forbidden ops
