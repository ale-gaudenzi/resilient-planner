(define (domain satellite)
    ...
    (:action turn_to-0
        ...
        :effect (oneof
            ...
            (and(faults_1)
                (not(faults_0))(turn_to ?s ?d_new ?d_prev))
        )
    )
    ...
    (:action take_image-0
        ...
        :effect (oneof(have_image ?d ?m)
            (and(faults_1)
                (not(faults_0))(take_image ?s ?d ?i ?m)))
    )
    ...
    (:action turn_to-1
        ...
        :effect (oneof
            (and (pointing ?s ?d_new) (not (pointing ?s ?d_prev)))
            (and(faults_2)
                (not(faults_1))(turn_to ?s ?d_new ?d_prev))
        )
    )
    ...
    (:action take_image-1
        ...
        :effect (oneof(have_image ?d ?m)
            (and(faults_2)
                (not(faults_1))(take_image ?s ?d ?i ?m)))
    )
    ...
    (:action turn_to-2
        :parameters ( ?s ?d_new ?d_prev)
        :precondition (and (faults_2)(satellite ?s) (direction ?d_new) (direction ?d_prev) (pointing ?s ?d_prev)
            (not(turn_to ?s ?d_new ?d_prev)))
    ...
    (:action switch_on-2
        :parameters ( ?i ?s)
        :precondition (and (faults_2)(instrument ?i) (satellite ?s) (on_board ?i ?s) (power_avail ?s)
            (not(switch_on ?i ?s)))
    ...
    (:action switch_off-2
        :parameters ( ?i ?s)
        :precondition (and (faults_2)(instrument ?i) (satellite ?s) (on_board ?i ?s) (power_on ?i)
            (not(switch_off ?i ?s)))
    ...
    (:action calibrate-2
        :parameters ( ?s ?i ?d)
        :precondition (and (faults_2)(satellite ?s) (instrument ?i) (direction ?d) (on_board ?i ?s) (calibration_target ?i ?d) (pointing ?s ?d) (power_on ?i)
            (not(calibrate ?s ?i ?d)))
        :effect (calibrated ?i)
    )
    ...
    (:action take_image-2
        :parameters ( ?s ?d ?i ?m)
        :precondition (and (faults_2)(satellite ?s) (direction ?d) (instrument ?i) (mode ?m) (calibrated ?i) (on_board ?i ?s) (supports ?i ?m) (power_on ?i) (pointing ?s ?d) (power_on ?i)
            (not(take_image ?s ?d ?i ?m)))
