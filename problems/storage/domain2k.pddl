...
(define (domain Storage-Propositional)
	...
	(:action drop-1
		:parameters (?h - hoist ?c - crate ?a1 - storearea ?a2 - area ?p - place)
		:precondition (and (connected ?a1 ?a2) (at ?h ?a2) (lifting ?h ?c)
			(clear ?a1) (in ?a1 ?p) (not(drop ?h ?c ?a1 ?a2 ?p)) (faults_1)
		)
		:effect (oneof
			(and (not (lifting ?h ?c)) (available ?h)
				(not (clear ?a1)) (on ?c ?a1) (in ?c ?p))
			(and(faults_2)
				(not(faults_1))(drop ?h ?c ?a1 ?a2 ?p))
		)
	)
	...
	(:action drop-2
		:parameters (?h - hoist ?c - crate ?a1 - storearea ?a2 - area ?p - place)
		:precondition (and (faults_2)(connected ?a1 ?a2) (at ?h ?a2) (lifting ?h ?c)
	...
	(:action go-out-2
		:parameters (?h - hoist ?from - storearea ?to - transitarea)
		:precondition (and(faults_2) (at ?h ?from) (connected ?from ?to) (not(go-out ?h ?from ?to)))
